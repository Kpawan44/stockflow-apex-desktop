            ...
            <button
              onClick={async () => {
                try {
                  ...
                  alert(`Successfully auto-rearranged transfer series! Updated ${res?.updatedCount || 0} transfer series numbers.`);
                } catch (e: any) {
              ...
              title="Auto Rearrange Transfer Series sequentially (TRF-1001, TRF-1002...) to eliminate gaps"
            >
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="bg-indigo-50/50 border border-indigo-100 rounded-xl p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <p className="text-[10px] text-indigo-600 font-semibold max-w-xs">
                ★ Guaranteed unique sequential transfer reference. Automatically rearranges if prior orders are deleted.
              </p>
            </div>
